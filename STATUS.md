...
- The latest local verification (`docs/VERIFICATION.md`, 2026-09-02 UTC+8) reports typecheck, 309 tests across 21 files, focused and external adversarial replay checks, production build, actionlint, and diff check passing.
