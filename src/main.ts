...
function sourceAtlas() {
  ...
  const groupBoundary: Record<SourceAtlasTrack, Copy> = {
    'difference-engine-no-2': { en: 'Babbage archive designs/notations are H/E1; the 1991/2002 built engine is an R/E2 reconstruction.', zh: 'Babbage 档案设计/记法是 H/E1；1991/2002 建成机器是 R/E2 复原。' },
    'bush-differential-analyzer': { en: 'Surviving component roles do not prove the exact browser wiring order.', zh: '存世部件角色不能证明浏览器中的确切连接顺序。' },
