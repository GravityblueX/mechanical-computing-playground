...
export interface NamedMachineSourceAnchor {
  ...
  documentRole?: 'patent' | 'operator manual' | 'service manual' | 'historical publication' | 'archive drawing' | 'technical description' | 'emulator documentation';
  accessHost?: string;
}
...
export const NAMED_MACHINE_SOURCE_ANCHORS: readonly NamedMachineSourceAnchor[] = [
  {
    id: 'de2-technical-description-2020', track: 'difference-engine-no-2', generation: { en: 'modern institutional reconstruction, completed 2002', zh: '现代机构复原，2002 年完成' }, sourceTitle: "Charles Babbage's Difference Engine No. 2: Technical Description", institution: 'Science Museum', accessHost: 'Science Museum PDF host', sourceUrl: 'https://www.sciencemuseum.org.uk/sites/default/files/2023-09/DE2_Technical_Description.pdf', recordIdentifier: 'Doron D. Swade, March 2020; 232-page PDF', claimType: 'R', evidenceStrength: 'E2', accessKind: 'institutional reconstruction', inspectedDate: '2026-09-01', documentRole: 'technical description', fullFacsimileInspected: true, pageFigureAnchors: ['p. i (scope and reconstruction boundary)', 'pp. 4–9 (sources and modern manufacturing drawings)', 'pp. 21–24, Figs. 3.2–3.4 (F/385/1 and A/171 interpretation)', 'pp. 33–45, Figs. 3.16–3.20 (warning/carry/restoration)', 'pp. 49–54, Figs. 4.1–4.3 (output transfer)', 'pp. 83–85 (modern paper-system additions)', 'pp. 187–188 (original versus reconstructed lock timing)', 'pp. 212–218 (archive/construction drawing appendices)'], researchNoteAnchor: 'research/difference-engine-source-map.md#directly-inspected-institutional-technical-description',
    supports: [{ en: 'institutional interpretation of the calculating cycle and calculated-result transfer to printing/stereotype roles, with modern design decisions and modifications explicitly identified', zh: '机构对计算周期及结果转入打印/铸版职责的解释，并明确标出现代设计决策与修改' }],
    notEstablished: [{ en: 'a Babbage-lifetime built artifact, or Babbage-specified manufacturing tolerances, materials, exact lock phasing, modern fixes, or repository event order', zh: 'Babbage 生前建成的实物，或由 Babbage 规定的制造公差、材料、确切锁定相位、现代修正或本站事件顺序' }],
  },
  {
    id: 'bab-b-001', track: 'difference-engine-no-2', generation: { en: 'Babbage DE2 design, 1847–1848', zh: 'Babbage 差分机二号设计，1847–1848' }, sourceTitle: 'Elevation of Difference Engine No.2', institution: 'Science Museum Group', sourceUrl: 'https://collection.sciencemuseumgroup.org.uk/documents/aa110117998/elevation-of-difference-engine-no-2', recordIdentifier: 'BAB/B/001 / aa110117998', claimType: 'H', evidenceStrength: 'E1', accessKind: 'direct archive record', inspectedDate: '2026-09-01', documentRole: 'archive drawing', fullFacsimileInspected: false, pageFigureAnchors: [], researchNoteAnchor: 'research/difference-engine-source-map.md#general-design-and-calculationaddition-drive-subjects',
    supports: [{ en: 'one-sheet elevation-record identity, 1847–1848 date, Babbage maker attribution, open access, and catalogued DE2 elevation subject', zh: '单张立面图档案身份、1847–1848 年代、Babbage 制作者归属、开放访问及目录所述差分机二号立面主题' }],
    notEstablished: [{ en: 'tooth counts, linkage interpretation, timing, materials, tolerances, construction choices, or every interpretation in the modern technical description', zh: '齿数、连杆解释、时序、材料、公差、建造选择，或现代技术说明中的全部解释' }],
  },
  {
  ...
  {
    id: 'bush-caldwell-thomas-fermi-1931', track: 'bush-differential-analyzer', generation: { en: 'original MIT analyzer application, 1931', zh: 'MIT 原始分析机应用，1931' }, sourceTitle: 'Thomas-Fermi Equation Solution by the Differential Analyzer', institution: 'Physical Review / American Physical Society', accessHost: 'APS Harvest fulltext service', sourceUrl: 'https://harvest.aps.org/v2/journals/articles/10.1103/PhysRev.38.1898/fulltext', recordIdentifier: 'DOI 10.1103/PhysRev.38.1898; Physical Review 38, 1898–1902', claimType: 'H', evidenceStrength: 'E1', accessKind: 'direct primary facsimile', inspectedDate: '2026-09-01', documentRole: 'historical publication', fullFacsimileInspected: true, pageFigureAnchors: ['printed p. 1898 (application, independent check, separate construction-paper boundary)', 'printed p. 1899 (problem procedure)', 'printed pp. 1900–1902, Figs. 1–3 (problem-specific connection diagrams; scales/signs/gear ratios disregarded)', 'printed p. 1902 (independent integration check)'], researchNoteAnchor: 'research/differential-analyzer.md#bush-and-caldwell-1931-directly-inspected-application-paper',
    supports: [{ en: 'an actual 1931 Thomas–Fermi calculation, its stated procedure and independent check, and published problem-specific multiplier/input/integrator/output-table schematic roles', zh: '1931 年实际 Thomas–Fermi 计算、文中所述流程与独立校验，以及针对该问题发表的乘法器/输入台/积分器/输出台示意职责' }],
    notEstablished: [{ en: 'a construction manual, exact shaft routing, placement, scale factors, gear ratios, permanent repository A+B → integrator → tracer wiring, or later analyzer geometry', zh: '建造手册、确切轴路由、布置、比例因子、齿轮比、本站 A+B → 积分器 → 描迹器的永久连接，或后续分析机几何' }],
  },
  {
  ...
  {
    id: 'curta-type2-service', track: 'curta', generation: { en: 'Curta Model II replacement-leaf service document', zh: 'Curta Model II 换页式维修文档' }, sourceTitle: 'Servicehandbuch – Service Manual: CURTA Mod. II', institution: 'Contina AG, Vaduz FL', accessHost: 'mycurta.com specialist mirror; index credits Museum Mura source layer', sourceUrl: 'https://www.mycurta.com/Documents/Curta_2_Service_Manual_Curta2_green_e.pdf', recordIdentifier: 'English/German-titled 43-page image-only scan; no cover date/revision/capacity visible', claimType: 'H', evidenceStrength: 'E1', accessKind: 'specialist-hosted primary facsimile', inspectedDate: '2026-09-01', documentRole: 'service manual', fullFacsimileInspected: false, pageFigureAnchors: ['PDF p. 1 cover', 'PDF p. 2 replacement-leaf and Model-I-picture warning', 'PDF p. 6 / leaf N I-a', 'PDF p. 10 / leaf O-1-2', 'PDF p. 34 / leaf S 3'], researchNoteAnchor: 'research/curta-source-map.md#23-type-ii-service-manual',
    supports: [{ en: 'Type II service responsibility at inspected leaves: mainshaft zero position during retaining-bush work, carriage/locking-pin handling, reversing-lever assembly, clearing plate, crank and zero-positioner groups', zh: '在已检查页确认 Type II 维修责任：固定套操作时主轴须在零位、滑架/锁销处理、换向杆总成、清零板、曲柄及零位机构分组' }],
    notEstablished: [{ en: 'one dated frozen revision, Type II capacity, equality with reused Model I pictures, operator timing, complete linkage geometry, or repository control-event identity', zh: '单一带日期的冻结修订、Type II 容量、与复用 Model I 图片完全相同、操作者时序、完整连杆几何或与本站控制事件等同' }],
  },
  {
  ...
  {
    id: 'ae-hpb-1888-transcription', track: 'analytical-engine', generation: { en: '1888 Bath paper / 1889 Spon compilation / modern access layers', zh: '1888 Bath 论文 / 1889 Spon 汇编 / 现代访问层' }, sourceTitle: 'Proceedings of the British Association, 1888 / The Analytical Engine', institution: 'E. & F. N. Spon 1889 publication; Cambridge University Press reproduction metadata', accessHost: 'Cambridge Core chapter metadata/preview + Fourmilab specialist transcription', sourceUrl: 'https://www.cambridge.org/core/books/abs/babbages-calculating-engines/proceedings-of-the-british-association-1888/4F94AD873CF05781394F2D9B91C1DAFB', recordIdentifier: 'chapter 32; 1889 printed compilation pp. 331–338; DOI 10.1017/CBO9780511694721.033; items 10–20 content remains transcription-only', claimType: 'H', evidenceStrength: 'E3', accessKind: 'specialist transcription', inspectedDate: '2026-09-01', documentRole: 'historical publication', fullFacsimileInspected: false, pageFigureAnchors: ['Cambridge chapter-range metadata: pp. 331–338; no content-page assignment for items 10–20'], researchNoteAnchor: 'research/analytical-engine-information-flow.md#2-h-p-babbage-paper-1888-event-1889-print-modern-access-layers',
    supports: [{ en: 'Cambridge E1 metadata identifies the 1889 compilation, chapter 32 and pp. 331–338; Fourmilab E3 transcribes Number/Directive/Operation roles and (ab+c)d in items 10–20', zh: 'Cambridge E1 元数据确认 1889 汇编、第 32 章及 331–338 页；Fourmilab E3 转录编号 10–20 的 Number/Directive/Operation 角色与 (ab+c)d' }],
    notEstablished: [{ en: 'which exact page within 331–338 contains items 10–20, facsimile typography, exact roller synchronization, a cross-walk to modern BAB drawing codes, or that the repository fixture values/order are historical', zh: '331–338 中编号 10–20 所在确切页、影印版式、滚筒精确同步、与现代 BAB 图纸代码的对照，或本站示例数值/顺序属于历史事实' }],
  },
  {
