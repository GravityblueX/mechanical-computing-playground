...
- [ ] Add a direct-multiplication functional model based on the Steiger / Millionaire source map in `research/multiplication-mechanisms.md`.
- [ ] Extend the multiplication comparison so it contrasts **operator-supplied repetition** with **mechanically encoded multiplication-table selection**.
...
- [ ] Re-run typecheck/tests/build after the next code change and update `docs/VERIFICATION.md`.
