...
12. **Source atlas / 史料图谱** — inspect four tracks: Difference Engine No. 2, Bush Differential Analyzer, Curta, and Analytical Engine. Cards separate primary document identity, access host/mirror, evidence strength, reconstruction/transcription, and repository teaching models.
