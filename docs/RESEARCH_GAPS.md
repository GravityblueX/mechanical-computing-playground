...
- Curta full operator/service edition mapping, readable per-leaf dates and complete replacement chronology for the undated green Type II assemblies, and production Type I/II revision/linkage mapping; a systematic page census now separately establishes one German autumn-1967 Type II issue, while capacity and 1951–1953 BOM/drawing dates remain distinct source layers;
